...
Actions.load.listen(function () {
    Request.get(evaStatusContentUrl, function (res) {
...
EVA_STATUS_TABLE = React.createClass({displayName: "EVA_STATUS_TABLE",
            ...
            React.createElement("div", null, 
                ...
                this.state.levels.map(function (level) {
                    ...
                    this.state.levels.map(function (level) {
                        ...
                        return (
                            React.createElement("td", null, matchedEvaStatusList.length, "(", this.getListeningEvaStatusBetweenPeriod(matchedEvaStatusList), ")")
                            )
                    }.bind(this)), 
                    ...
                    this.state.departs.map(function (depart) {
                        ...
                        return (React.createElement("tr", null, 
                            React.createElement("td", null, depart.label), 
                            this.state.levels.map(function (level) {
                                var matchedEvaStatusList = $.grep(this.state.evaStatusList, function (evaStatus) {
                                    return depart.isDepart(evaStatus) && level.isLevel(evaStatus);
                                });
                                return React.createElement("td", null, 
                                    React.createElement("div", null, matchedEvaStatusList.length, "(", this.getListeningEvaStatusBetweenPeriod(matchedEvaStatusList), ")"), 
                                    matchedEvaStatusList.map(function (evaStatus) {
                                        ...
                                        return React.createElement("div", null, 
                                            React.createElement("a", {style: style}, evaStatus.name, "(", this.getLessonsBeforePeriod(evaStatus), " + ", this.getLessonsBetweenPeriod(evaStatus), " + ", this.getLessonsAfterPeriod(evaStatus), ")")
                                        )
                                    }.bind(this))
                                    )
                            }.bind(this)), 
    ...
    render: function () {
        ...
        return React.createElement("div", null, 
            React.createElement("span", {style: style}, 
                React.createElement("label", null, "開始"), 
                React.createElement("input", {type: "number", min: "2012", max: "2020", ref: "startYear", value: this.state.startYear, onChange: this.onChange}), 
            "年", 
                React.createElement("input", {type: "number", min: "1", max: "12", ref: "startMonth", value: this.state.startMonth, onChange: this.onChange}), 
            "月", 
                React.createElement("input", {type: "number", min: "1", max: "31", ref: "startDay", value: this.state.startDay, onChange: this.onChange}), 
            "日"
            ), 
            React.createElement("span", {style: style}, 
                React.createElement("label", null, "結束"), 
                React.createElement("input", {type: "number", min: "2012", max: "2020", ref: "endYear", value: this.state.endYear, onChange: this.onChange}), 
            "年", 
                React.createElement("input", {type: "number", min: "1", max: "12", ref: "endMonth", value: this.state.endMonth, onChange: this.onChange}), 
            "月", 
                React.createElement("input", {type: "number", min: "1", max: "31", ref: "endDay", value: this.state.endDay, onChange: this.onChange}), 
            "日"
            ), 
            React.createElement(Button, {bsStyle: "primary", onClick: this.submit}, "送出")
        )
    }
})

var LogoutBtn = React.createClass({displayName: "LogoutBtn",
    onClick: function () {
        window.location.href = '/logout';
    },
    render: function () {
        return React.createElement(Button, {bsStyle: "danger", style: {float: 'right'}, onClick: this.onClick}, "Logout")
    }
})
...
React.render((
    React.createElement("div", {style: {padding: '20px'}}, 
        ...
        React.createElement(EVA_STATUS_TABLE, null)
    )
