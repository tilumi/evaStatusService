        ...
        return (
            React.createElement(Navbar, null, 
                React.createElement(Nav, null, 
                    React.createElement(NavItem, null, "話語補聽"), 
                    React.createElement(NavItem, null, "話語搜尋"), 
                    React.createElement(NavItem, null, "宣教表格")
...
},{}],"/Users/lucasmf/Documents/workspace-sts-3.6.3.SR1/forever-official/libexec/evaStatusService/static/client-app/js/finder/index.js":[function(require,module,exports){
...
var FileContextMenu = React.createClass({displayName: "FileContextMenu",
    render: function () {
        return (
            React.createElement("div", {id: "context-menu"}, 
                React.createElement("ul", {className: "dropdown-menu", role: "menu"}, 
                    React.createElement("li", {action: "delete"}, 
                        React.createElement("a", null, "Delete")
                    ), 
                    React.createElement("li", {action: "rename"}, 
                        React.createElement("a", null, "Rename")
                    )
                )
            )
        );
...
var DirContextMenu = React.createClass({displayName: "DirContextMenu",
    render: function () {
        return (
            React.createElement("div", {id: "dir-context-menu"}, 
                React.createElement("ul", {className: "dropdown-menu", role: "menu"}, 
                    React.createElement("li", {action: "mkdir"}, 
                        React.createElement("a", null, "Create Dir")
                    )
                )
            )
        );
...
var File = React.createClass({displayName: "File",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {onContextMenu: this.onClickEvent, onClick: this.onClickEvent, onDoubleClick: this.open, style: style, ref: "fileDiv"}, 
                React.createElement("img", {src: this.state.iconUrl}), 
...
var Finder = React.createClass({displayName: "Finder",
    ...
    render: function () {
        return (
            React.createElement("div", {ref: "finderDiv"}, 
            this.state.list.map(function (elem) {
                return (
                    React.createElement(File, {file: elem}
                    )
                );
            }, this)
            )
...
var VideoPlayer = React.createClass({displayName: "VideoPlayer",
    ...
    render: function () {
        return React.createElement("div", {id: "videoPlayer"});
    }
});

var PlayerModal = React.createClass({displayName: "PlayerModal",
    ...
    renderOverlay: function () {
        ...
        return (
            React.createElement(Modal, {title: "Player", onRequestHide: this.handleToggle}, 
...
var FileUploadModal = React.createClass({displayName: "FileUploadModal",
    ...
    render: function () {
        return (
            React.createElement(Button, {onClick: this.handleToggle, bsStyle: "primary"}, "Upload")
        );
    },
    ...
    renderOverlay: function () {
        ...
        return (
            React.createElement(Modal, {title: "File Upload", onRequestHide: this.handleToggle}, 
                React.createElement("div", {className: "modal-body"}, 
                    React.createElement(FinderUpload, {currentDir: this.state.currentDir})
                )
            )
        );
    }
...
var FinderUpload = React.createClass({displayName: "FinderUpload",
    ...
    render: function () {
        return (
            React.createElement("form", null, 
                ...
                React.createElement("input", {type: "file", ref: "file", onChange: this.setFile}), 
                this.state.progresses.map(function (elem) {
                    return (
                        React.createElement("div", null, 
                            React.createElement("span", null, elem.file.name), 
                            React.createElement(ProgressBar, {active: true, now: elem.progress})
                        )
                    );
                }, this), 
...
var Footer = React.createClass({displayName: "Footer",
    ...
    render: function () {
        ...
        return (
            React.createElement(Navbar, {style: footerStyle}, 
                React.createElement(Button, {bsStyle: "primary", bsSize: "large", style: btnStyle, onClick: this.open}, "Open")
            )
        )
    }
});
...
React.render((React.createElement("div", null, 
    ...
    React.createElement(DirContextMenu, null), 
    React.createElement(FileContextMenu, null), 
    React.createElement(PlayerModal, null), 
    React.createElement(Finder, null), 
    React.createElement(FileUploadModal, null), 
...
},{}],"/Users/lucasmf/Documents/workspace-sts-3.6.3.SR1/forever-official/libexec/evaStatusService/static/node_modules/browserify/lib/_empty.js":[function(require,module,exports){

},{}],"/Users/lucasmf/Documents/workspace-sts-3.6.3.SR1/forever-official/libexec/evaStatusService/static/node_modules/showdown/src/showdown.js":[function(require,module,exports){
(function (__dirname){
//
...
},{}]},{},["/Users/lucasmf/Documents/workspace-sts-3.6.3.SR1/forever-official/libexec/evaStatusService/static/client-app/js/finder/index.js"])
